/*  
 six core concept
 1 variable 
 2. conditions (comparison >, >== === !== if-else ) 
 3. Array 
 4. loop ( for loop , while loop, break , continue  )
 5. function  peramiter, return, call 
 6. Object (properties, keys  loop object properties )
*/

/* 
 1 google function declaretion  vs function expression
 2. google : arraw function  
 3. google :  loop vs function 
 4. array vs object 
 5. intiger vs flote 
 6. == vs === 
 7. var ,  let , const 
...
3. কেউ ১০০ এর মধ্যে কত মার্ক্স্ পেয়েছে সেটা তোমাকে বলে দিবে। তুমি একটা ফাংশন দিয়ে বলে দিবে সে এ+ পা  বে নাকি অন্য কোন গ্রেড পাবে। 
